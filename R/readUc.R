...
#'
#' @description
#' Reads .uc files (USEARCH Cluster Format) generated by the VSEARCH clustering
...
#'
#' @details
#' USEARCH cluster format is a tab separated text file that contains
#' clustering and/or alignment information for a set of sequences. For each
#' sequence a record type, "H, C or N", is provided providing information
#' about the type of "hit" in the dataframe. These refer to:
#' \itemize{
#'   \item H - Hit - for alignments, indicates an identified alignment of
#'   two supplied sequences. For clustering, indicates the cluster assignment
#'   for a query.
#'   \item C - Cluster record - a record for each cluster generated.
#'   \item N - No hit - indicates that no cluster was assigned or no
#'   alignment was found with a target sequence. For clustering, a query with
#'   no hits becomes the centroid of a new cluster.
#' }
#' Additionally, for each record a "compressed alignment" is generated. This is
...
#' }
#' An example of this would be "13M", referring to 13 consecutive matches
