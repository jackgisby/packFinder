...
#'
#' @description
#' Reads .blast6out files (NCBI Blast Format) generated by the VSEARCH
...
#'   \item Number of gaps
#'   \item Base position of alignment start in query sequence
...
#'
#' @details
#' The blast6out file is tab-separated text file compatible with NCBI BLAST m8
#' and NCBI BLAST+ outfmt 6 formats. One cluster/alignment can be found for
#' each line.
#'
#' @seealso
#' code{\link{tirClust}}, code{\link{packAlign}}, code{\link{readUc}},
#' code{\link{packClust}}
#'
#' @references
