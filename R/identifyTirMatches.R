...
#'
#' @param mismatch
#'     The allowable mismatch between \code{tirSeq} 
#'     and a given slice of \code{Genome}. Includes indels.
#'
#' @param strand
...
#'
#' @param tsdLength
#'     Integer referring to the length 
#'     of the flanking TSD region.
#'
#' @author
#'     Jack Gisby
#'
#' @details
#'     Called by \code{\link{packSearch}}. Used 
#'     by \code{\link{packSearch}} as an initial 
#'     filtering stage. 
#'     \code{\link[Biostrings]{matchPattern}} from 
#'     Biostrings is used for pattern matching. It 
#'     is recommended to use the general pipeline 
#'     function \code{\link{packSearch}} for 
#'     identification of potential pack elements, 
#'     however each stage may be called individually.
#'
#' @return
#'     A dataframe, \code{tirMatches}, containing 
#'     identified matches. The dataframe is in the 
#'     format generated by \code{\link{packSearch}}.
#' 
#' @examples
