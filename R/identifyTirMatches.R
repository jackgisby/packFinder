...
#'
#' @param Genome
#' A \code{\link[Biostrings]{DNAStringSet}} object containing the DNAString objects to be searched.
#'
#' @param mismatch
#' The allowable mismatch between \code{subSeq} and a given slice of \code{Genome}. Includes indels.
#'
#' @param strand
...
#'
#' @return
#' A dataframe, \code{tirMatches}, containing identified matches. Will be appended to \code{tirMatches} if given. The dataframe is in the format generated by \code{\link[GenomicRanges]{makeGRangesFromDataFrame}}.
#'
#' @export
