...
Visualise <- function(Genome, forwardMatches, reverseMatches, chrList) {
  # takes a dataframe of the forward and reverse matches to be plotted, and the genome they were found in
  # writes data to intermediate TSV files required for chromoMap
  # returns a visualisation of the locations of substring matches in the genome
