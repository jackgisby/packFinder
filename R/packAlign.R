#' @title Global Alignment with VSEARCH
#' @description A global pairwise alignment of pack-TYPE elements by sequence similarity.
...
#' @param identityDefinition The pairwise identity definition used by VSEARCH. Defaults to 1, the BLAST definition.
#' @param saveFolder The folder to save saveFolder files (uc, blast6out, FASTA)
...
#' @author Jack Gisby
#' @return Saves alignment information, including a \code{uc}, \code{blast6out} and a pairwise alignment \code{fasta} file, to the specified location. Returns the uc summary file generated by the alignment..
