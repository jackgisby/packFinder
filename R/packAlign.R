...
#'
#' @description
#'     A global pairwise alignment of pack-TYPE 
#'     elements by sequence similarity. mIt may be 
#'     useful to run \code{\link{packClust}} to 
#'     identify groups of similar transposable 
#'     elements, before generating alignments of 
#'     each group.
#'
#' @param packMatches
...
#'
#' @param identity
#'     The sequence identity of two transposable 
#'     elements in \code{packMatches} required to be 
...
#'
#' @note
#'     In order to align sequences using VSEARCH, 
...
#'
#' @return
#'     Saves alignment information, including a 
#'     \code{uc}, \code{blast6out} and a pairwise 
#'     alignment \code{fasta} file, to the 
#'     specified location. Returns the uc summary 
#'     file generated by the alignment.
#'
#' @references
#'     VSEARCH may be downloaded from 
#'     \url{https://github.com/torognes/vsearch}, 
#'     along with a manual documenting the 
#'     program's parameters. See 
