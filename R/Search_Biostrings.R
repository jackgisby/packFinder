getMatches <- function(SearchString, Genome, chrList = NULL, max.mismatch = 0, with.indels = FALSE, fixed = TRUE) {
...
getMatchesChr <- function(SubSeqForward, Chr, chrName = NULL, max.mismatch = 0, with.indels = FALSE, fixed = TRUE){
