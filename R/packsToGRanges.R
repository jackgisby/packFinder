...
#' to sequences to be extracted, likely obtained from \code{\link{packSearch}},
#' can be converted to a GRanges object. Can be converted back to a dataframe
#' using \code{\link{getPacksFromGRanges}}. Additional features, such as
#' clusters and TSD sequences, will be included in the object as metadata
#' columns.
#'
#'
#' @param packMatches
