...
reverseMatches <- identifyTirMatches(Biostrings::DNAString("CACTACAA"), arabidopsisThalianaRefseq)
```
...
```{r getTsds}
forwardMatches$TSD <- getTsds(forwardMatches, arabidopsisThalianaRefseq, 3)
reverseMatches$TSD <- getTsds(reverseMatches, arabidopsisThalianaRefseq, 3)
```
