...
*The method of identity detection is the same as in BLAST searches

The identity and method of identity definition can be altered depending on analysis. 
...
```{r}
packMatches <- identifyPotentialPackElements(forwardMatches, reverseMatches, arabidopsisThalianaRefseq, c(300, 500))
```
