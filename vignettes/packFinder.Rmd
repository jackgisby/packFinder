...
packsToFasta(packMatches, "data/packMatches.fasta")
...
```{r}
forwardMatches$TSD <- getTsds(forwardMatches)
reverseMatches$TSD <- getTsds(reverseMatches)
```
...
```{r}
packMatches <- identifyPotentialPackElements(forwardMatches, reverseMatches)
```
