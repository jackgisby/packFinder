...
packsToFasta(packMatches, "data/packMatches.fasta", arabidopsisThalianaRefseq)
...
```{r csvConvert}
packsToCsv(packMatches, "data/packMatches.csv")
print(getPacksFromCsv("data/packMatches.csv"))
```
...
```{r fastaConvert}
packsToFasta(packMatches, "data/packMatches.fasta", arabidopsisThalianaRefseq)
print(getPacksFromFasta("data/packMatches.fasta"))
```
